...
class Zend_Test_PHPUnit_Constraint_DomQuery41 extends PHPUnit_Framework_Constraint
{
     ...
     * @param  string|bool $match      (optional) String to match (needle), may be required depending on assertion type
     *
     * @return bool
     */
     ...
     * @param  PHPUnit_Framework_ComparisonFailure $comparisonFailure Cannot be used, null
     *
